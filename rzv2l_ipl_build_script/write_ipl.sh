...
class FlashUtil:
	...
	def __setupArgumentParser(self):
		...
		self.__parser.add_argument('--serial_port', default='/dev/ttyUSB2', dest='serialPort', action='store', help='Serial port used to talk to board (defaults to: /dev/ttyUSB0).')
